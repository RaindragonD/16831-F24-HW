...
class MPCPolicy(BasePolicy):
    ...
    def calculate_sum_of_rewards(self, obs, candidate_action_sequences, model):
        ...
        for h in range(self.horizon):
            actions = candidate_action_sequences[:, h, :]  # Actions for all sequences at horizon step h
            next_obs_pred = model.get_prediction(obs, actions, self.data_statistics)
            rewards, _ = self.env.get_reward(next_obs_pred, actions)
